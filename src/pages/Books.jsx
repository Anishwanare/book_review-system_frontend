...
const Books = () => {
    ...
    return (
        <div className='max-w-6xl mx-auto py-6 px-4 h-screen'>
            <h1 className="  md:my-10 text-center text-xl md:text-2xl font-semibold text-orange-500 cursor-pointer underline">Explore Bookiesss</h1>
            <hr />
